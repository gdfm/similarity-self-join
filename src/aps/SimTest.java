...
public class SimTest extends Configured implements Tool {
    ...
    private static final Log LOG = LogFactory.getLog(SimTest.class);
    ...
    public static class IndexerMapper extends MapReduceBase implements
        ...
        public void map(IntWritable vectorID, VectorComponentArrayWritable value,
            ...
            //TODO INXDEX EVERYTHING LIKE IN V1
    ...
    public int run(String[] args) throws IOException {
        ...
        JobConf conf1 = new JobConf(getConf(), SimTest.class);
        ...
        // part 2
        JobConf conf2 = new JobConf(getConf(), SimTest.class);
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new SimTest(), args);
